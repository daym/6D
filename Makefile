...
CFLAGS += -Ilib/include $(LIBGC_LD_WRAP_CFLAGS) $(shell pkg-config --cflags glib-2.0 gthread-2.0 libedit) -g3 -O0
LDFLAGS += lib/lib6dbuiltins1.a -lgc -lm $(shell pkg-config --libs glib-2.0 gthread-2.0 libedit)
all: TUI/T5D
